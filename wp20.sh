...
setup_server() {
    ...
    local packages_needed=(
        ...
        php7.4-mbstring php7.4-zip php7.4-intl php7.4-bcmath
    )
...
add_website() {
    ...
    # Membuat wp-config.php tanpa konfigurasi Redis
...
EOF
    ...
    # Menginstal plugin tanpa redis-cache
