...
install_dependencies() {
    print_info "Memulai instalasi dependensi untuk Ubuntu 20.04..."
    ...
    print_info "Menambahkan PPA PHP dari Ondřej Surý..."
    run_task "Menambahkan repositori PPA" "sudo add-apt-repository ppa:ondrej/php -y"
    run_task "Memperbarui daftar paket setelah menambah PPA" "sudo apt-get update -y"

    print_info "Menginstal PHP 7.4 dan ekstensi (termasuk Redis)..."
    sudo DEBIAN_FRONTEND=noninteractive apt-get install -y \
        php7.4-fpm php7.4-mysql php7.4-xml php7.4-curl php7.4-gd \
        php7.4-imagick php7.4-mbstring php7.4-zip php7.4-intl php7.4-bcmath php7.4-redis
...
show_menu() {
    ...
    echo -e "${C_CYAN}"
    echo "=========================================================="
    echo "  🚀 SCRIPT INSTALASI WP - UBUNTU 20.04 & PHP 7.4 🚀  "
    echo "=========================================================="
    echo -e "${C_RESET}"
